...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
    <style>
        .card {
            background-image: linear-gradient(to right, rgba(255, 255, 255, 0), rgb(76, 121, 255));
        }
    </style>
    <div class="container py-5">
        ...
        <div class="card text-white mb-3" style="background-color: #210b81;">
            <div class="card-header"style="color: white" >Data Pasien</div>
            <div class="card-body">
                <div class="container mt-3">
                    <div class="row">
                        <div style="color: white">
                            <div>
                                <p>Cari Berdasarkan Nama Pasien</p>
                            </div>
                        </div>
                    </div>
                    <form action="{{ url('/dashboard/books') }}">
                    ...
                    <form method="post" action="{{ url('/dashboard/books/import') }}" enctype="multipart/form-data">
                        <div style="color: white">
                            <p>Input Data Pasien dari file spreadsheet (.xlsx, .xls, .csv)</p>
                        </div>
                        @csrf
                        <div class="input-group mb-3">
            ...
            <a href="{{ url('/dashboard/books/create') }}" class="btn btn-lg btn-primary">Tambah Data Pasien </a>
        </div>
        <div class="row">
            <div class="col">
                        ...
                        <tbody>
                            @foreach ($books as $key => $book)
                                <tr>
                                    ...
                                    <td>{{ $book->judul }}</td>
                                    <td>{!! DNS2D::getBarcodeHTML('http://147.139.206.220/sosialhub/barcode?barcode=' . $book->no_barcode, 'QRCODE') !!}</td>
