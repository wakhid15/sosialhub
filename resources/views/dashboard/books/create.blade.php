    ...
    <section>
        <div class="row py-5">
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="post" action="{{ url('/dashboard/books') }}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">Kategori Pasien</p>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                        name="judul" required placeholder="Masukkan Nama Pasien...">
                                    @error('judul')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="pengarang"
                                        placeholder="Masukkan Keluarga..." required>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="eksemplar"
                                        placeholder="Masukkan Umur..." required id="intTextBox2">
                                </div>
                            </div>
                            <hr>
                            <button class="btn btn-primary" type="submit">Tambahkan Data Pasien</button>
                        </form>
                    </div>
                </div>
            </div>
