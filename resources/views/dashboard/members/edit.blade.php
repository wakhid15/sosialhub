    ...
    <section>
        <div class="row py-5">
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="post" action="{{ url('/dashboard/members/' . $member->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-sm-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="jns_anggota" required
                                        value="{{ old('jns_anggota', $member->jns_anggota) }}">
                                </div>
                                {{-- <div class="col-sm-9">
                            ...
                            <hr>
                            <button class="btn btn-primary" type="submit">Ubah Anggota Keluarga</button>
                        </form>
                    </div>
                </div>
            </div>
