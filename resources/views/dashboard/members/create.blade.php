    ...
    <section>
        <div class="row py-5">
            ...
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="post" action="{{ url('/dashboard/members') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" id="books" name="nama" required>
                                        @foreach ($books as $book)
                                            <option value="{{ $book->judul }}" {{ old('nama') == $book->judul ? 'selected' : '' }}>
                                                {{ $book->judul }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control @error('nisn') is-invalid @enderror"
                                        name="nisn" required placeholder="Masukkan NIK..." maxlength="20"
                                        id="intTextBox2">
                                    @error('nisn')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="jns_anggota" required
