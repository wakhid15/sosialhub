    ...
    <div class="row">
        <nav id="sidebarMenu" class="col-md-4 col-lg-2 d-md-block bg-light sidebar collapse">
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="{{ url('/dashboard') }}" class="nav-link {{ $active === 'index' ? 'active' : '' }}"
                ...
                <h6
                  ...
                  <li>
                    <a href="{{ url('/dashboard/raks') }}" class="nav-link {{ $active === 'raks' ? 'active' : '' }} link-dark"><i
                            class="bi bi-journal-text"></i>
                        Data Kategori Pasien
                    </a>
                </li>
                <li>
                    <a href="{{ url('/dashboard/books') }}" class="nav-link {{ $active === 'books' ? 'active' : '' }} link-dark"><i
                            class="bi bi-journal-text"></i>
                        Data Pasien
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ url('/dashboard/users') }}" class="nav-link {{ $active === 'users' ? 'active' : '' }} link-dark"><i
                            class="bi bi-journal-text"></i>
                        Data Petugas
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ url('/dashboard/profiles/' . Auth::id()) }}"
