...
class TransactionController extends Controller
{
    ...
    public function index()
    {
        return view('dashboard.transactions.index', [
            ...
            'members' => Member::all(),
            'active' => 'transactions',
'transactions' => Transaction::with(['book', 'user', 'member'])->latest()->paginate(7),
    ...
    public function store(StoreTransactionRequest $request)
    {
        ...
        return redirect('/dashboard/transactions')->with('success', 'Data Kehilangan baru telah ditambahkan.');
    }
    /**
     * Store a newly created resource in storage.
     *
    ...
    public function prosespengembalian(Request $request)
    {
        ...
        return redirect('/dashboard/transactions')->with('success', 'Data Kehilangan telah selesai.');
    }
    ...
    public function update(UpdateTransactionRequest $request, Transaction $transaction)
    {
        if ($request->status == 'PEMINJAMAN') {
            ...
            // Book::find($request->book_id)->increment('eksemplar', $transaction['jml_pinjam']);
            // Book::find($request->book_id)->decrement('eksemplar', $request['jml_pinjam']);
            return redirect('/dashboard/transactions')->with('success', 'Data Kehilangan telah diubah.');
        }
    }
    ...
    public function destroy(Transaction $transaction)
    {
        ...
        return redirect('/dashboard/transactions')->with('success', 'Data Kehilangan telah dihapus.');
    }
}
