...
class BookController extends Controller
{
    ...
    public function store(StoreBookRequest $request)
    {
        ...
        return redirect('/dashboard/books')->with('success', 'Data Pasien baru telah ditambahkan.');
    }
    ...
    public function update(UpdateBookRequest $request, Book $book)
    {
        ...
        return redirect('/dashboard/books')->with('success', 'Data Pasien telah diubah!.');
    }
    ...
    public function destroy(Book $book)
    {
        ...
        return redirect('/dashboard/books')->with('success', 'Data Pasien telah dihapus.');
    }
    ...
    public function import(Request $request)
{
    ...
    $file->move(public_path('imports'), $nama_file);

    // import data
    Excel::import(new BookImport, public_path('imports/' . $nama_file));

    // notifikasi dengan session
    return redirect('/dashboard/books')->with('success', 'Data Buku Berhasil Diimport!');
}

public function barcodePage()
{
    $active = 'barcode'; // Set variabel $active dengan nilai 'barcode'
    return view('barcode_page', compact('active'));
}
