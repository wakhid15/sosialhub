...
class MemberController extends Controller
{
    ...
    public function store(StoreMemberRequest $request)
    {
        ...
        return redirect('/dashboard/members')->with('success', 'Anggota Keluarga baru telah ditambahkan.');
    }
    ...
    public function update(UpdateMemberRequest $request, Member $member)
    {
        ...
        return redirect('/dashboard/members')->with('success', 'Anggota Keluarga telah diubah!.');
    }
    ...
    public function destroy(Member $member)
    {
        ...
        return redirect('/dashboard/members')->with('success', 'Anggota Keluarga telah dihapus.');
    }
}
