...
class RakController extends Controller
{
    ...
    public function store(StoreRakRequest $request)
    {
        ...
        return redirect('/dashboard/raks')->with('success', 'Kategori Pasien baru telah ditambahkan.');
    }
    ...
    public function update(UpdateRakRequest $request, Rak $rak)
    {
        ...
        return redirect('/dashboard/raks')->with('success', 'Kategori Pasien telah diubah!.');
    }
    ...
    public function destroy(Rak $rak)
    {
        ...
        return redirect('/dashboard/raks')->with('success', 'Kategori Pasien telah dihapus.');
    }
}
